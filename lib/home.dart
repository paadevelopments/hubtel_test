        ...
        ? SizedBox(
          ...
          : Padding(
            ...
            child: Column(children: data.asMap().entries.map((listItem) {
              bool addDateLabel = listItem.key == 0 ? true : daysBetween(DateTime.parse(listItem.value["time"]), DateTime.parse(data[listItem.key - 1]["time"])) > 1;
              return Column(
                children: [
                  ...
                  Padding(padding: EdgeInsets.only(bottom: 16),child: Column(children: [
                    Container(
                      width: double.maxFinite,
                      decoration: BoxDecoration(
